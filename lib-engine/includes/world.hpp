...
public:
  Entity(long id, std::vector<std::shared_ptr<Component>> components) : id(id), components(components) {}
...
public:
  ...
  void registerEntity(std::vector<std::shared_ptr<Component>> components);
